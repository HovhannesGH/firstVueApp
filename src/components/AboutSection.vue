...
const skills = ref([
    { title: "Photography", percentage: 90, class: "progress-photography progress" },
    { title: "Web Design", percentage: 85, class: "progress-web-design progress" },
...
watch(scrollY, (newValue) => {
    if (newValue > 1150 && newValue < 2040) {
        if (currentPartners.value === 0) {
            animateValue(currentPartners, maxPartners, (frame) => (partnersAnimationFrame = frame));
        }
        if (currentProjectsDone.value === 0) {
            animateValue(currentProjectsDone, maxProjectsDone, (frame) => (projectsAnimationFrame = frame));
        }
        if (currentHappyClients.value === 0) {
            animateValue(currentHappyClients, maxHappyClients, (frame) => (happyClientsAnimationFrame = frame));
        }
        if (currentMeetings.value === 0) {
            animateValue(currentMeetings, maxMeetings, (frame) => (meetingsAnimationFrame = frame));
        }
    } else {
...
<template>
    <div class="about" id="about">
        <div class="about__first-block">
            ...
            <p class="about__info">We have created a fictional "personal" website/blog, and our fictional
                character
        ...
        <div class="about__second-block">
            ...
            <div class="about-section-second-block-right">
                <p class="about-section-second-block-right-info">Welcome to my website. I am lorem ipsum consectetur
        ...
        <div class="about-section-forth-block">
            <div class="info-section">
                <div class="partners-number" v-for="(stat, index) in statistics" :key="index">
